...
<head>
	...
	<script type="text/javascript">
		function registerCheckFunction() {
			...
			$.ajax({
				type: 'POST',
				url: './UserRegisterCheckServlet.chat',
				data: {userID: userID},
...
<body>
	...
	<div class="container">
		<form method="post" action="./UserRegisterServlet.chat">
			<table class="table table-bordered table-hover" 
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="text" id="userName" name="userName" maxlength="20" placeholder="이름을 입력 입력하세요."></td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>나이</h5></td>
						<td colspan="2"><input class="form-control" type="text" id="userAge" name="userAge" maxlength="20" placeholder="나이를 입력 입력하세요."></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="email" id="userEmail" name="userEmail" maxlength="20" placeholder="이메일을 입력 입력하세요."></td>
					</tr>
					<tr>
